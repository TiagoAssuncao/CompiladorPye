...
static const char *const yytname[] =
{
  ...
  "RIGHT_PARENTHESIS", "COLON", "NUMBER", "IDENTIFIER", "'\\n'", "';'",
  "'='", "'+'", "'-'", "$accept", "input", "command", "command_finisher",
  "assignment", "expression", "term", "function_declaration",
...
{
       3,    15,    -9,    13,    -9,     0,    -9,     4,    -8,    -9,
      -9,    21,     8,    -9,    -9,    -9,    -9,    -9,    -9,    -9,
      10,    10,    -9,    -9,    -9,     7,    -9,    -9,    -9,    22,
      20,    -9
};
...
{
       0,     0,    17,    18,     6,     0,     2,     0,     0,    14,
       4,     0,     0,     1,     7,     3,     5,    10,    11,     8,
...
{
      13,    17,    18,     1,    20,    21,     1,     2,     3,    14,
       2,     3,     4,    17,    18,     2,     3,     2,    26,    20,
      21,    27,    28,    11,    12,    23,    31,    30,    15,    24,
      25,    16,    22
};

static const yytype_uint8 yycheck[] =
{
       0,     9,    10,     3,    12,    13,     3,     7,     8,     9,
       7,     8,     9,     9,    10,     7,     8,     7,     8,    12,
      13,    20,    21,     8,    11,     4,     6,     5,     5,    12,
      12,     5,     8
};
...
{
       0,     3,     7,     8,     9,    15,    16,    18,    19,    20,
      21,     8,    11,     0,     9,    16,    21,     9,    10,    17,
      12,    13,    17,     4,    18,    19,     8,    20,    20,    22,
       5,     6
};
...
#line 37 "cmp/pye.y" /* yacc.c:1646  */
    {;}
#line 1240 "pye.tab.c" /* yacc.c:1646  */
    break;
